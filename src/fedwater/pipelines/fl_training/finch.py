...
Vendored unchanged from the BEPE codebase (utils/finch.py), which carries it
from the reference implementation at github.com/ssarfraz/FINCH-Clustering.
Used by the FPL server to cluster per-month client prototypes (cosine).
"""
import numpy as np
...
try:
    ...
    pynndescent_available = False  # only needed above 70k samples
